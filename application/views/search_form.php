...
{
   $.ajax({
              url: "<?php echo base_url();?>index.php/search/set_search",
              type: "POST",
...
<div id="container">
<form class="form-horizontal" method="post" action="search/listed">
<fieldset>
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="ad_title" name="ad_title" type="text" placeholder="" class="form-control input-md">
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-4">
    <button id="signup_button" name="signup_button" class="btn btn-primary" onclick="set_search()"><?=$this->lang->line("public_button"); ?></button>
  </div>
</div>
